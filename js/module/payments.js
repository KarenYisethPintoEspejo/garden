...
export const getALLCodeRequests2008 = async()=>{
    let res = await fetch("http://localhost:5415/payments?date_payment")
...
export const getAllPaymentsPayPal2008 = async() => {
    let res = await fetch("http://localhost:5415/payments?payment=PayPal");
    let data = await res.json();
    let dataUpdate= [];
...
export const getAllPaymentMethods = async() => {
    let res = await fetch("http://localhost:5415/payments");
    let data = await res.json();
